...
eox-itemfilter-expandcontainer button.reset-icon:before {
  ...
  `;var Oa=Object.defineProperty,La=Object.getOwnPropertyDescriptor,Hi=(t,e,r,i)=>{for(var n=i>1?void 0:i?La(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&Oa(e,r,n),n};let kr=class extends _e{handleDetailsToggle(t){this.dispatchEvent(new CustomEvent("details-toggled",{detail:t,bubbles:!0,composed:!0}))}_resetFilter(){this.querySelector("[slot='filter']").reset()}render(){return U`
      <style>
        ${Ii}
        ${!this.unstyled&&Ni}
      </style>
    ...
    `}};Hi([Q({attribute:!1})],kr.prototype,"filterObject",2);Hi([Q()],kr.prototype,"unstyled",2);kr=Hi([Ce("eox-itemfilter-expandcontainer")],kr);const Nt=t=>{if(!t.dirty)return null;switch(t.type){case"multiselect":for(const e in t.state)t.state[e]=!1;break;case"range":t.state.min=t.min,t.state.max=t.max;break;case"select":for(const e in t.state)t.state[e]=!1;break;case"spatial":t.state.geometry=void 0;break;case"text":t.keys.forEach(e=>{t.state[e]=void 0});break}return delete t.stringifiedState,delete t.dirty,t},vi=Math.min,Rt=Math.max,Mr=Math.round,br=Math.floor,at=t=>({x:t,y:t});function ws(t){return t.split("-")[0]}function Ra(t){return t.split("-")[1]}function Ca(t){return t==="x"?"y":"x"}function ja(t){return t==="y"?"height":"width"}function $s(t){return["top","bottom"].includes(ws(t))?"y":"x"}function Da(t){return Ca($s(t))}function _s(t){return{...t,top:t.y,left:t.x,right:t.x+t.width,bottom:t.y+t.height}}function Hn(t,e,r){let{reference:i,floating:n}=t;const s=$s(e),o=Da(e),l=ja(o),a=ws(e),h=s==="y",p=i.x+i.width/2-n.width/2,f=i.y+i.height/2-n.height/2,b=i[l]/2-n[l]/2;let y;switch(a){case"top":y={x:p,y:i.y-n.height};break;case"bottom":y={x:p,y:i.y+i.height};break;case"right":y={x:i.x+i.width,y:f};break;case"left":y={x:i.x-n.width,y:f};break;default:y={x:i.x,y:i.y}}switch(Ra(e)){case"start":y[o]-=b*(r&&h?-1:1);break;case"end":y[o]+=b*(r&&h?-1:1);break}return y}const Ta=async(t,e,r)=>{const{placement:i="bottom",strategy:n="absolute",middleware:s=[],platform:o}=r,l=s.filter(Boolean),a=await(o.isRTL==null?void 0:o.isRTL(e));let h=await o.getElementRects({reference:t,floating:e,strategy:n}),{x:p,y:f}=Hn(h,i,a),b=i,y={},_=0;for(let A=0;A<l.length;A++){const{name:z,fn:q}=l[A],{x:g,y:m,data:w,reset:E}=await q({x:p,y:f,initialPlacement:i,placement:b,strategy:n,middlewareData:y,rects:h,platform:o,elements:{reference:t,floating:e}});p=g??p,f=m??f,y={...y,[z]:{...y[z],...w}},E&&_<=50&&(_++,typeof E=="object"&&(E.placement&&(b=E.placement),E.rects&&(h=E.rects===!0?await o.getElementRects({reference:t,floating:e,strategy:n}):E.rects),{x:p,y:f}=Hn(h,b,a)),A=-1)}return{x:p,y:f,placement:b,strategy:n,middlewareData:y}};function Ht(t){return Es(t)?(t.nodeName||"").toLowerCase():"#document"}function Re(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function it(t){var e;return(e=(Es(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function Es(t){return t instanceof Node||t instanceof Re(t).Node}function We(t){return t instanceof Element||t instanceof Re(t).Element}function Ve(t){return t instanceof HTMLElement||t instanceof Re(t).HTMLElement}function Fn(t){return typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof Re(t).ShadowRoot}function sr(t){const{overflow:e,overflowX:r,overflowY:i,display:n}=He(t);return/auto|scroll|overlay|hidden|clip/.test(e+i+r)&&!["inline","contents"].includes(n)}function Ia(t){return["table","td","th"].includes(Ht(t))}function Fi(t){const e=Bi(),r=He(t);return r.transform!=="none"||r.perspective!=="none"||(r.containerType?r.containerType!=="normal":!1)||!e&&(r.backdropFilter?r.backdropFilter!=="none":!1)||!e&&(r.filter?r.filter!=="none":!1)||["transform","perspective","filter"].some(i=>(r.willChange||"").includes(i))||["paint","layout","strict","content"].some(i=>(r.contain||"").includes(i))}function qa(t){let e=lt(t);for(;Ve(e)&&!Dt(e);){if(Fi(e))return e;e=lt(e)}return null}function Bi(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Dt(t){return["html","body","#document"].includes(Ht(t))}function He(t){return Re(t).getComputedStyle(t)}function Cr(t){return We(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.pageXOffset,scrollTop:t.pageYOffset}}function lt(t){if(Ht(t)==="html")return t;const e=t.assignedSlot||t.parentNode||Fn(t)&&t.host||it(t);return Fn(e)?e.host:e}function Ss(t){const e=lt(t);return Dt(e)?t.ownerDocument?t.ownerDocument.body:t.body:Ve(e)&&sr(e)?e:Ss(e)}function Zt(t,e,r){var i;e===void 0&&(e=[]),r===void 0&&(r=!0);const n=Ss(t),s=n===((i=t.ownerDocument)==null?void 0:i.body),o=Re(n);return s?e.concat(o,o.visualViewport||[],sr(n)?n:[],o.frameElement&&r?Zt(o.frameElement):[]):e.concat(n,Zt(n,[],r))}function ks(t){const e=He(t);let r=parseFloat(e.width)||0,i=parseFloat(e.height)||0;const n=Ve(t),s=n?t.offsetWidth:r,o=n?t.offsetHeight:i,l=Mr(r)!==s||Mr(i)!==o;return l&&(r=s,i=o),{width:r,height:i,$:l}}function Ui(t){return We(t)?t:t.contextElement}function Ct(t){const e=Ui(t);if(!Ve(e))return at(1);const r=e.getBoundingClientRect(),{width:i,height:n,$:s}=ks(e);let o=(s?Mr(r.width):r.width)/i,l=(s?Mr(r.height):r.height)/n;return(!o||!Number.isFinite(o))&&(o=1),(!l||!Number.isFinite(l))&&(l=1),{x:o,y:l}}const Na=at(0);function Ms(t){const e=Re(t);return!Bi()||!e.visualViewport?Na:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function Ha(t,e,r){return e===void 0&&(e=!1),!r||e&&r!==Re(t)?!1:e}function wt(t,e,r,i){e===void 0&&(e=!1),r===void 0&&(r=!1);const n=t.getBoundingClientRect(),s=Ui(t);let o=at(1);e&&(i?We(i)&&(o=Ct(i)):o=Ct(t));const l=Ha(s,r,i)?Ms(s):at(0);let a=(n.left+l.x)/o.x,h=(n.top+l.y)/o.y,p=n.width/o.x,f=n.height/o.y;if(s){const b=Re(s),y=i&&We(i)?Re(i):i;let _=b,A=_.frameElement;for(;A&&i&&y!==_;){const z=Ct(A),q=A.getBoundingClientRect(),g=He(A),m=q.left+(A.clientLeft+parseFloat(g.paddingLeft))*z.x,w=q.top+(A.clientTop+parseFloat(g.paddingTop))*z.y;a*=z.x,h*=z.y,p*=z.x,f*=z.y,a+=m,h+=w,_=Re(A),A=_.frameElement}}return _s({width:p,height:f,x:a,y:h})}const Fa=[":popover-open",":modal"];function zi(t){return Fa.some(e=>{try{return t.matches(e)}catch{return!1}})}function Ba(t){let{elements:e,rect:r,offsetParent:i,strategy:n}=t;const s=n==="fixed",o=it(i),l=e?zi(e.floating):!1;if(i===o||l&&s)return r;let a={scrollLeft:0,scrollTop:0},h=at(1);const p=at(0),f=Ve(i);if((f||!f&&!s)&&((Ht(i)!=="body"||sr(o))&&(a=Cr(i)),Ve(i))){const b=wt(i);h=Ct(i),p.x=b.x+i.clientLeft,p.y=b.y+i.clientTop}return{width:r.width*h.x,height:r.height*h.y,x:r.x*h.x-a.scrollLeft*h.x+p.x,y:r.y*h.y-a.scrollTop*h.y+p.y}}function Ua(t){return Array.from(t.getClientRects())}function As(t){return wt(it(t)).left+Cr(t).scrollLeft}function za(t){const e=it(t),r=Cr(t),i=t.ownerDocument.body,n=Rt(e.scrollWidth,e.clientWidth,i.scrollWidth,i.clientWidth),s=Rt(e.scrollHeight,e.clientHeight,i.scrollHeight,i.clientHeight);let o=-r.scrollLeft+As(t);const l=-r.scrollTop;return He(i).direction==="rtl"&&(o+=Rt(e.clientWidth,i.clientWidth)-n),{width:n,height:s,x:o,y:l}}function Ya(t,e){const r=Re(t),i=it(t),n=r.visualViewport;let s=i.clientWidth,o=i.clientHeight,l=0,a=0;if(n){s=n.width,o=n.height;const h=Bi();(!h||h&&e==="fixed")&&(l=n.offsetLeft,a=n.offsetTop)}return{width:s,height:o,x:l,y:a}}function Xa(t,e){const r=wt(t,!0,e==="fixed"),i=r.top+t.clientTop,n=r.left+t.clientLeft,s=Ve(t)?Ct(t):at(1),o=t.clientWidth*s.x,l=t.clientHeight*s.y,a=n*s.x,h=i*s.y;return{width:o,height:l,x:a,y:h}}function Bn(t,e,r){let i;if(e==="viewport")i=Ya(t,r);else if(e==="document")i=za(it(t));else if(We(e))i=Xa(e,r);else{const n=Ms(t);i={...e,x:e.x-n.x,y:e.y-n.y}}return _s(i)}function Ps(t,e){const r=lt(t);return r===e||!We(r)||Dt(r)?!1:He(r).position==="fixed"||Ps(r,e)}function Wa(t,e){const r=e.get(t);if(r)return r;let i=Zt(t,[],!1).filter(l=>We(l)&&Ht(l)!=="body"),n=null;const s=He(t).position==="fixed";let o=s?lt(t):t;for(;We(o)&&!Dt(o);){const l=He(o),a=Fi(o);!a&&l.position==="fixed"&&(n=null),(s?!a&&!n:!a&&l.position==="static"&&n&&["absolute","fixed"].includes(n.position)||sr(o)&&!a&&Ps(t,o))?i=i.filter(h=>h!==o):n=l,o=lt(o)}return e.set(t,i),i}function Va(t){let{element:e,boundary:r,rootBoundary:i,strategy:n}=t;const s=[...r==="clippingAncestors"?zi(e)?[]:Wa(e,this._c):[].concat(r),i],o=s[0],l=s.reduce((a,h)=>{const p=Bn(e,h,n);return a.top=Rt(p.top,a.top),a.right=vi(p.right,a.right),a.bottom=vi(p.bottom,a.bottom),a.left=Rt(p.left,a.left),a},Bn(e,o,n));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function Ka(t){const{width:e,height:r}=ks(t);return{width:e,height:r}}function Ja(t,e,r){const i=Ve(e),n=it(e),s=r==="fixed",o=wt(t,!0,s,e);let l={scrollLeft:0,scrollTop:0};const a=at(0);if(i||!i&&!s)if((Ht(e)!=="body"||sr(n))&&(l=Cr(e)),i){const f=wt(e,!0,s,e);a.x=f.x+e.clientLeft,a.y=f.y+e.clientTop}else n&&(a.x=As(n));const h=o.left+l.scrollLeft-a.x,p=o.top+l.scrollTop-a.y;return{x:h,y:p,width:o.width,height:o.height}}function fi(t){return He(t).position==="static"}function Un(t,e){return!Ve(t)||He(t).position==="fixed"?null:e?e(t):t.offsetParent}function Os(t,e){const r=Re(t);if(zi(t))return r;if(!Ve(t)){let n=lt(t);for(;n&&!Dt(n);){if(We(n)&&!fi(n))return n;n=lt(n)}return r}let i=Un(t,e);for(;i&&Ia(i)&&fi(i);)i=Un(i,e);return i&&Dt(i)&&fi(i)&&!Fi(i)?r:i||qa(t)||r}const Ga=async function(t){const e=this.getOffsetParent||Os,r=this.getDimensions,i=await r(t.floating);return{reference:Ja(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}};function Qa(t){return He(t).direction==="rtl"}const Za={convertOffsetParentRelativeRectToViewportRelativeRect:Ba,getDocumentElement:it,getClippingRect:Va,getOffsetParent:Os,getElementRects:Ga,getClientRects:Ua,getDimensions:Ka,getScale:Ct,isElement:We,isRTL:Qa};function el(t,e){let r=null,i;const n=it(t);function s(){var l;clearTimeout(i),(l=r)==null||l.disconnect(),r=null}function o(l,a){l===void 0&&(l=!1),a===void 0&&(a=1),s();const{left:h,top:p,width:f,height:b}=t.getBoundingClientRect();if(l||e(),!f||!b)return;const y=br(p),_=br(n.clientWidth-(h+f)),A=br(n.clientHeight-(p+b)),z=br(h),q={rootMargin:-y+"px "+-_+"px "+-A+"px "+-z+"px",threshold:Rt(0,vi(1,a))||1};let g=!0;function m(w){const E=w[0].intersectionRatio;if(E!==a){if(!g)return o();E?o(!1,E):i=setTimeout(()=>{o(!1,1e-7)},1e3)}g=!1}try{r=new IntersectionObserver(m,{...q,root:n.ownerDocument})}catch{r=new IntersectionObserver(m,q)}r.observe(t)}return o(!0),s}function tl(t,e,r,i){i===void 0&&(i={});const{ancestorScroll:n=!0,ancestorResize:s=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:a=!1}=i,h=Ui(t),p=n||s?[...h?Zt(h):[],...Zt(e)]:[];p.forEach(q=>{n&&q.addEventListener("scroll",r,{passive:!0}),s&&q.addEventListener("resize",r)});const f=h&&l?el(h,r):null;let b=-1,y=null;o&&(y=new ResizeObserver(q=>{let[g]=q;g&&g.target===h&&y&&(y.unobserve(e),cancelAnimationFrame(b),b=requestAnimationFrame(()=>{var m;(m=y)==null||m.observe(e)})),r()}),h&&!a&&y.observe(h),y.observe(e));let _,A=a?wt(t):null;a&&z();function z(){const q=wt(t);A&&(q.x!==A.x||q.y!==A.y||q.width!==A.width||q.height!==A.height)&&r(),A=q,_=requestAnimationFrame(z)}return r(),()=>{var q;p.forEach(g=>{n&&g.removeEventListener("scroll",r),s&&g.removeEventListener("resize",r)}),f==null||f(),(q=y)==null||q.disconnect(),y=null,a&&cancelAnimationFrame(_)}}const rl=(t,e,r)=>{const i=new Map,n={platform:Za,...r},s={...n.platform,_c:i};return Ta(t,e,{...n,platform:s})};var il=Object.defineProperty,nl=Object.getOwnPropertyDescriptor,jr=(t,e,r,i)=>{for(var n=i>1?void 0:i?nl(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&il(e,r,n),n};let er=class extends _e{constructor(){super(...arguments),this.open=!1,this.parent=null,this.unstyled=!1,this._clickEventListener=()=>{this.open=!1},this._keyboardEventListener=t=>{const{code:e}=t;["Escape"].includes(e)&&this._handleKeyboard(e)}}_handleKeyboard(t){this.clientHeight}_overlayCleanup(){}connectedCallback(){super.connectedCallback(),this.unstyled||setTimeout(()=>{const t=this.parent||this.renderRoot.querySelector("[name=trigger]").assignedNodes()[0],e=this.renderRoot.querySelector("#dropdown"),r=()=>{e.classList.contains("open")&&rl(t,e,{strategy:"fixed"}).then(({x:i,y:n})=>{Object.assign(e.style,{left:`${i}px`,top:`${n}px`,width:`${t.getBoundingClientRect().width}px`})})};this._overlayCleanup=tl(t,e,r)})}disconnectedCallback(){super.disconnectedCallback(),this._overlayCleanup(),this.getRootNode().removeEventListener("keydown",this._keyboardEventListener),window.removeEventListener("click",this._clickEventListener)}render(){return U`
      <style>
        #dropdown {
          display: none;
        }
    ...
    `}};Je([Q()],Fe.prototype,"idProperty",2);Je([Q()],Fe.prototype,"items",2);Je([Q()],Fe.prototype,"titleProperty",2);Je([Q()],Fe.prototype,"itemTitleProperty",2);Je([Q({type:Boolean})],Fe.prototype,"multiple",2);Je([Q({type:Boolean})],Fe.prototype,"unstyled",2);Je([Q({type:Boolean})],Fe.prototype,"multiStep",2);Je([rt()],Fe.prototype,"inputText",2);Je([rt()],Fe.prototype,"selectedItems",2);Fe=Je([Ce("eox-autocomplete")],Fe);var cl=Object.defineProperty,hl=Object.getOwnPropertyDescriptor,Ge=(t,e,r,i)=>{for(var n=i>1?void 0:i?hl(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&cl(e,r,n),n};let Be=class extends _e{constructor(){super(...arguments),this.filter="",this.idProperty="id",this.items=[],this.titleProperty="title",this.multiple=!1,this.selectedItems=[],this.unstyled=!1,this.noShadow=!1,this._currentHighlight=null,this._keyboardEventListener=t=>{["ArrowDown","ArrowUp","Enter","Escape"].includes(t.code)&&this._handleKeyboard(t.code)}}_handleKeyboard(t){if(this.clientHeight===0)return;const e=this.renderRoot.querySelector("li.highlighted");if(t==="Escape"){this._currentHighlight&&(this._currentHighlight=null);return}if(t==="Enter"){if(e){const s=this.items.find(o=>o[this.idProperty]===e.dataset.identifier);this._handleSelect(s),this.requestUpdate()}return}const r=this.renderRoot.querySelectorAll("li");let i=-1;e&&(delete e.dataset.highlighted,i=Array.from(r).indexOf(e)),t==="ArrowDown"&&(i++,i>r.length-1&&(i=0)),t==="ArrowUp"&&(i--,i<0&&(i=r.length-1));const n=Array.from(r)[i];n&&(this._currentHighlight=this.items.find(s=>s[this.idProperty]===n.dataset.identifier)),this.dispatchEvent(new CustomEvent("items-highlighted",{detail:[this._currentHighlight]}))}_handleSelect(t){if(t)if(this.multiple){const e=this.selectedItems.find(r=>r[this.idProperty]===t[this.idProperty]);e?this.selectedItems.splice(this.selectedItems.indexOf(e),1):this.selectedItems.push(t)}else this.selectedItems=[t];else this.selectedItems=[],this._currentHighlight=null;this._dispatchEvent()}_dispatchEvent(){this.dispatchEvent(new CustomEvent("items-selected",{detail:this.selectedItems}))}disconnectedCallback(){super.disconnectedCallback(),this.getRootNode().removeEventListener("keydown",this._keyboardEventListener)}firstUpdated(){this.getRootNode().addEventListener("keydown",this._keyboardEventListener)}updated(t){t.has("filter")&&(this.filter.length>0?setTimeout(()=>{const e=this.renderRoot.querySelectorAll("li")[0];e&&(this._currentHighlight=this.items.find(r=>r[this.idProperty]===e.dataset.identifier))}):this._currentHighlight=null)}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return U`
      ...
      <ul>
        ${vs(this.items.filter(t=>this.filter?t[this.titleProperty].toLowerCase().includes(this.filter.toLowerCase()):!0),t=>t[this.idProperty],t=>U`
            <li
    ...
    `}};Ge([Q()],Be.prototype,"filter",2);Ge([Q()],Be.prototype,"idProperty",2);Ge([Q()],Be.prototype,"items",2);Ge([Q()],Be.prototype,"titleProperty",2);Ge([Q({type:Boolean})],Be.prototype,"multiple",2);Ge([Q()],Be.prototype,"selectedItems",2);Ge([Q({type:Boolean})],Be.prototype,"unstyled",2);Ge([Q({type:Boolean})],Be.prototype,"noShadow",2);Ge([rt()],Be.prototype,"_currentHighlight",2);Be=Ge([Ce("eox-selectionlist")],Be);var ul=Object.defineProperty,dl=Object.getOwnPropertyDescriptor,Tr=(t,e,r,i)=>{for(var n=i>1?void 0:i?dl(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&ul(e,r,n),n};let rr=class extends _e{constructor(){super(...arguments),this.inline=!1,this.unstyled=!1}reset(){this.renderRoot.querySelectorAll("input[type='checkbox']").forEach(t=>{t instanceof HTMLInputElement&&(t.checked=!1)}),Nt(this.filterObject),this.requestUpdate()}createRenderRoot(){return this}_getItems(){const t="sort"in this.filterObject?this.filterObject.sort:(e,r)=>e.localeCompare(r);return Object.keys(this.filterObject.state).sort(t).map(e=>({id:e,title:e.replace(/^./,e[0].toUpperCase())}))}_getSelectedItems(){return Object.keys(this.filterObject.state).filter(t=>this.filterObject.state[t]).map(t=>({id:t,title:t.replace(/^./,t[0].toUpperCase())}))}_handleSelected(t){var e;Object.keys(this.filterObject.state).forEach(r=>{this.filterObject.state[r]=t.map(i=>i.id).includes(r)}),this.filterObject.stringifiedState=Object.keys(this.filterObject.state).filter(r=>this.filterObject.state[r]).join(", "),((e=this.filterObject.stringifiedState)==null?void 0:e.length)>0&&(this.filterObject.dirty=!0),this.dispatchEvent(new CustomEvent("filter"))}render(){return de(this.filterObject,()=>U`
        ${de(this.inline||Object.keys(this.filterObject.state).length>10,()=>U`
          ...
          `,()=>U`
            ...
            ></eox-selectionlist>
          `)}
      `)}};Tr([Q()],rr.prototype,"filterObject",2);Tr([Q({type:Boolean})],rr.prototype,"inline",2);Tr([Q({type:Boolean})],rr.prototype,"unstyled",2);rr=Tr([Ce("eox-itemfilter-multiselect")],rr);var pl="Expected a function",zn=NaN,fl="[object Symbol]",gl=/^\s+|\s+$/g,ml=/^[-+]0x[0-9a-f]+$/i,yl=/^0b[01]+$/i,vl=/^0o[0-7]+$/i,bl=parseInt,xl=typeof Ot=="object"&&Ot&&Ot.Object===Object&&Ot,wl=typeof self=="object"&&self&&self.Object===Object&&self,$l=xl||wl||Function("return this")(),_l=Object.prototype,El=_l.toString,Sl=Math.max,kl=Math.min,gi=function(){return $l.Date.now()};function Ml(t,e,r){var i,n,s,o,l,a,h=0,p=!1,f=!1,b=!0;if(typeof t!="function")throw new TypeError(pl);e=Yn(e)||0,bi(r)&&(p=!!r.leading,f="maxWait"in r,s=f?Sl(Yn(r.maxWait)||0,e):s,b="trailing"in r?!!r.trailing:b);function y(S){var k=i,L=n;return i=n=void 0,h=S,o=t.apply(L,k),o}function _(S){return h=S,l=setTimeout(q,e),p?y(S):o}function A(S){var k=S-a,L=S-h,H=e-k;return f?kl(H,s-L):H}function z(S){var k=S-a,L=S-h;return a===void 0||k>=e||k<0||f&&L>=s}function q(){var S=gi();if(z(S))return g(S);l=setTimeout(q,A(S))}function g(S){return l=void 0,b&&i?y(S):(i=n=void 0,o)}function m(){l!==void 0&&clearTimeout(l),h=0,i=a=n=l=void 0}function w(){return l===void 0?o:g(gi())}function E(){var S=gi(),k=z(S);if(i=arguments,n=this,a=S,k){if(l===void 0)return _(a);if(f)return l=setTimeout(q,e),y(a)}return l===void 0&&(l=setTimeout(q,e)),o}return E.cancel=m,E.flush=w,E}function bi(t){var e=typeof t;return!!t&&(e=="object"||e=="function")}function Al(t){return!!t&&typeof t=="object"}function Pl(t){return typeof t=="symbol"||Al(t)&&El.call(t)==fl}function Yn(t){if(typeof t=="number")return t;if(Pl(t))return zn;if(bi(t)){var e=typeof t.valueOf=="function"?t.valueOf():t;t=bi(e)?e+"":e}if(typeof t!="string")return t===0?t:+t;t=t.replace(gl,"");var r=yl.test(t);return r||vl.test(t)?bl(t.slice(2),r?2:8):ml.test(t)?zn:+t}var Ol=Ml;const Ls=Di(Ol);var Ll=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,Rs=(t,e,r,i)=>{for(var n=i>1?void 0:i?Rl(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&Ll(e,r,n),n};let xi=class extends _e{constructor(){super(...arguments),this.inputHandler=t=>{const[e,r]=t.detail.values;(e!==this.filterObject.state.min||r!=this.filterObject.state.max)&&([this.filterObject.state.min,this.filterObject.state.max]=[e,r],this.filterObject.dirty=!0),this.filterObject.dirty&&(this.filterObject.stringifiedState=`${Lt(e)} - ${Lt(r)}`),this.dispatchEvent(new CustomEvent("filter")),this.requestUpdate()},this.debouncedInputHandler=Ls(this.inputHandler,0,{leading:!0})}reset(){Nt(this.filterObject),this.requestUpdate()}createRenderRoot(){return this}render(){return de(this.filterObject,()=>U`
      ...
      `)}};Rs([Q()],xi.prototype,"filterObject",2);xi=Rs([Ce("eox-itemfilter-range")],xi);var Cl=Object.defineProperty,jl=Object.getOwnPropertyDescriptor,Ir=(t,e,r,i)=>{for(var n=i>1?void 0:i?jl(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&Cl(e,r,n),n};let ir=class extends _e{constructor(){super(...arguments),this.inline=!1,this.unstyled=!1}reset(){this.renderRoot.querySelectorAll("input[type='radio']").forEach(t=>{t instanceof HTMLInputElement&&(t.checked=!1)}),Nt(this.filterObject),this.requestUpdate()}createRenderRoot(){return this}_getItems(){const t="sort"in this.filterObject?this.filterObject.sort:(e,r)=>e.localeCompare(r);return Object.keys(this.filterObject.state).sort(t).map(e=>({id:e,title:e.replace(/^./,e[0].toUpperCase())}))}_getSelectedItems(){return Object.keys(this.filterObject.state).filter(t=>this.filterObject.state[t]).map(t=>({id:t,title:t.replace(/^./,t[0].toUpperCase())}))}_handleSelected(t){var e;Object.keys(this.filterObject.state).forEach(r=>{this.filterObject.state[r]=t.detail.map(i=>i.id).includes(r)}),this.filterObject.stringifiedState=Object.keys(this.filterObject.state).filter(r=>this.filterObject.state[r])[0],((e=this.filterObject.stringifiedState)==null?void 0:e.length)>0&&(this.filterObject.dirty=!0),this.dispatchEvent(new CustomEvent("filter"))}render(){return de(this.filterObject,()=>U`
        ${de(this.inline||Object.keys(this.filterObject.state).length>10,()=>U`
          ...
          `,()=>U`
            ...
            ></eox-selectionlist>
          `)}
      `)}};Ir([Q()],ir.prototype,"filterObject",2);Ir([Q({type:Boolean})],ir.prototype,"inline",2);Ir([Q({type:Boolean})],ir.prototype,"unstyled",2);ir=Ir([Ce("eox-itemfilter-select")],ir);var Se=63710088e-1,Yi={centimeters:Se*100,centimetres:Se*100,degrees:Se/111325,feet:Se*3.28084,inches:Se*39.37,kilometers:Se/1e3,kilometres:Se/1e3,meters:Se,metres:Se,miles:Se/1609.344,millimeters:Se*1e3,millimetres:Se*1e3,nauticalmiles:Se/1852,radians:1,yards:Se*1.0936},Dl={centimeters:100,centimetres:100,degrees:1/111325,feet:3.28084,inches:39.37,kilometers:1/1e3,kilometres:1/1e3,meters:1,metres:1,miles:1/1609.344,millimeters:1e3,millimetres:1e3,nauticalmiles:1/1852,radians:1/Se,yards:1.0936133},wi={acres:247105e-9,centimeters:1e4,centimetres:1e4,feet:10.763910417,hectares:1e-4,inches:1550.003100006,kilometers:1e-6,kilometres:1e-6,meters:1,metres:1,miles:386e-9,millimeters:1e6,millimetres:1e6,yards:1.195990046};function Te(t,e,r){r===void 0&&(r={});var i={type:"Feature"};return(r.id===0||r.id)&&(i.id=r.id),r.bbox&&(i.bbox=r.bbox),i.properties=e||{},i.geometry=t,i}function Tl(t,e,r){switch(t){case"Point":return Ye(e).geometry;case"LineString":return Ne(e).geometry;case"Polygon":return Xi(e).geometry;case"MultiPoint":return Cs(e).geometry;case"MultiLineString":return Wi(e).geometry;case"MultiPolygon":return js(e).geometry;default:throw new Error(t+" is invalid")}}function Ye(t,e,r){if(r===void 0&&(r={}),!t)throw new Error("coordinates is required");if(!Array.isArray(t))throw new Error("coordinates must be an Array");if(t.length<2)throw new Error("coordinates must be at least 2 numbers long");if(!Ar(t[0])||!Ar(t[1]))throw new Error("coordinates must contain numbers");var i={type:"Point",coordinates:t};return Te(i,e,r)}function Il(t,e,r){return r===void 0&&(r={}),ct(t.map(function(i){return Ye(i,e)}),r)}function Xi(t,e,r){r===void 0&&(r={});for(var i=0,n=t;i<n.length;i++){var s=n[i];if(s.length<4)throw new Error("Each LinearRing of a Polygon must have 4 or more Positions.");for(var o=0;o<s[s.length-1].length;o++)if(s[s.length-1][o]!==s[0][o])throw new Error("First and last Position are not equivalent.")}var l={type:"Polygon",coordinates:t};return Te(l,e,r)}function ql(t,e,r){return r===void 0&&(r={}),ct(t.map(function(i){return Xi(i,e)}),r)}function Ne(t,e,r){if(r===void 0&&(r={}),t.length<2)throw new Error("coordinates must be an array of two or more positions");var i={type:"LineString",coordinates:t};return Te(i,e,r)}function Nl(t,e,r){return r===void 0&&(r={}),ct(t.map(function(i){return Ne(i,e)}),r)}function ct(t,e){e===void 0&&(e={});var r={type:"FeatureCollection"};return e.id&&(r.id=e.id),e.bbox&&(r.bbox=e.bbox),r.features=t,r}function Wi(t,e,r){r===void 0&&(r={});var i={type:"MultiLineString",coordinates:t};return Te(i,e,r)}function Cs(t,e,r){r===void 0&&(r={});var i={type:"MultiPoint",coordinates:t};return Te(i,e,r)}function js(t,e,r){r===void 0&&(r={});var i={type:"MultiPolygon",coordinates:t};return Te(i,e,r)}function Hl(t,e,r){r===void 0&&(r={});var i={type:"GeometryCollection",geometries:t};return Te(i,e,r)}function Fl(t,e){if(e===void 0&&(e=0),e&&!(e>=0))throw new Error("precision must be a positive number");var r=Math.pow(10,e||0);return Math.round(t*r)/r}function Ds(t,e){e===void 0&&(e="kilometers");var r=Yi[e];if(!r)throw new Error(e+" units is invalid");return t*r}function Vi(t,e){e===void 0&&(e="kilometers");var r=Yi[e];if(!r)throw new Error(e+" units is invalid");return t/r}function Bl(t,e){return Ts(Vi(t,e))}function Ul(t){var e=t%360;return e<0&&(e+=360),e}function Ts(t){var e=t%(2*Math.PI);return e*180/Math.PI}function zl(t){var e=t%360;return e*Math.PI/180}function Yl(t,e,r){if(e===void 0&&(e="kilometers"),r===void 0&&(r="kilometers"),!(t>=0))throw new Error("length must be a positive number");return Ds(Vi(t,e),r)}function Xl(t,e,r){if(e===void 0&&(e="meters"),r===void 0&&(r="kilometers"),!(t>=0))throw new Error("area must be a positive number");var i=wi[e];if(!i)throw new Error("invalid original units");var n=wi[r];if(!n)throw new Error("invalid final units");return t/i*n}function Ar(t){return!isNaN(t)&&t!==null&&!Array.isArray(t)}function Ki(t){return!!t&&t.constructor===Object}function Wl(t){if(!t)throw new Error("bbox is required");if(!Array.isArray(t))throw new Error("bbox must be an Array");if(t.length!==4&&t.length!==6)throw new Error("bbox must be an Array of 4 or 6 numbers");t.forEach(function(e){if(!Ar(e))throw new Error("bbox must only contain numbers")})}function Vl(t){if(!t)throw new Error("id is required");if(["string","number"].indexOf(typeof t)===-1)throw new Error("id must be a number or a string")}const Kl=Object.freeze(Object.defineProperty({__proto__:null,areaFactors:wi,bearingToAzimuth:Ul,convertArea:Xl,convertLength:Yl,degreesToRadians:zl,earthRadius:Se,factors:Yi,feature:Te,featureCollection:ct,geometry:Tl,geometryCollection:Hl,isNumber:Ar,isObject:Ki,lengthToDegrees:Bl,lengthToRadians:Vi,lineString:Ne,lineStrings:Nl,multiLineString:Wi,multiPoint:Cs,multiPolygon:js,point:Ye,points:Il,polygon:Xi,polygons:ql,radiansToDegrees:Ts,radiansToLength:Ds,round:Fl,unitsFactors:Dl,validateBBox:Wl,validateId:Vl},Symbol.toStringTag,{value:"Module"}));function Is(t){if(!t)throw new Error("coord is required");if(!Array.isArray(t)){if(t.type==="Feature"&&t.geometry!==null&&t.geometry.type==="Point")return t.geometry.coordinates;if(t.type==="Point")return t.coordinates}if(Array.isArray(t)&&t.length>=2&&!Array.isArray(t[0])&&!Array.isArray(t[1]))return t;throw new Error("coord must be GeoJSON Point or an Array of numbers")}function Tt(t){if(Array.isArray(t))return t;if(t.type==="Feature"){if(t.geometry!==null)return t.geometry.coordinates}else if(t.coordinates)return t.coordinates;throw new Error("coords must be GeoJSON Feature, Geometry Object or an Array")}function It(t){return t.type==="Feature"?t.geometry:t}function De(t,e,r){if(r===void 0&&(r={}),!t)throw new Error("point is required");if(!e)throw new Error("polygon is required");var i=Is(t),n=It(e),s=n.type,o=e.bbox,l=n.coordinates;if(o&&Jl(i,o)===!1)return!1;s==="Polygon"&&(l=[l]);for(var a=!1,h=0;h<l.length&&!a;h++)if(Xn(i,l[h][0],r.ignoreBoundary)){for(var p=!1,f=1;f<l[h].length&&!p;)Xn(i,l[h][f],!r.ignoreBoundary)&&(p=!0),f++;p||(a=!0)}return a}function Xn(t,e,r){var i=!1;e[0][0]===e[e.length-1][0]&&e[0][1]===e[e.length-1][1]&&(e=e.slice(0,e.length-1));for(var n=0,s=e.length-1;n<e.length;s=n++){var o=e[n][0],l=e[n][1],a=e[s][0],h=e[s][1],p=t[1]*(o-a)+l*(a-t[0])+h*(t[0]-o)===0&&(o-t[0])*(a-t[0])<=0&&(l-t[1])*(h-t[1])<=0;if(p)return!r;var f=l>t[1]!=h>t[1]&&t[0]<(a-o)*(t[1]-l)/(h-l)+o;f&&(i=!i)}return i}function Jl(t,e){return e[0]<=t[0]&&e[1]<=t[1]&&e[2]>=t[0]&&e[3]>=t[1]}function Ft(t,e,r){if(t!==null)for(var i,n,s,o,l,a,h,p=0,f=0,b,y=t.type,_=y==="FeatureCollection",A=y==="Feature",z=_?t.features.length:1,q=0;q<z;q++){h=_?t.features[q].geometry:A?t.geometry:t,b=h?h.type==="GeometryCollection":!1,l=b?h.geometries.length:1;for(var g=0;g<l;g++){var m=0,w=0;if(o=b?h.geometries[g]:h,o!==null){a=o.coordinates;var E=o.type;switch(p=r&&(E==="Polygon"||E==="MultiPolygon")?1:0,E){case null:break;case"Point":if(e(a,f,q,m,w)===!1)return!1;f++,m++;break;case"LineString":case"MultiPoint":for(i=0;i<a.length;i++){if(e(a[i],f,q,m,w)===!1)return!1;f++,E==="MultiPoint"&&m++}E==="LineString"&&m++;break;case"Polygon":case"MultiLineString":for(i=0;i<a.length;i++){for(n=0;n<a[i].length-p;n++){if(e(a[i][n],f,q,m,w)===!1)return!1;f++}E==="MultiLineString"&&m++,E==="Polygon"&&w++}E==="Polygon"&&m++;break;case"MultiPolygon":for(i=0;i<a.length;i++){for(w=0,n=0;n<a[i].length;n++){for(s=0;s<a[i][n].length-p;s++){if(e(a[i][n][s],f,q,m,w)===!1)return!1;f++}w++}m++}break;case"GeometryCollection":for(i=0;i<o.geometries.length;i++)if(Ft(o.geometries[i],e,r)===!1)return!1;break;default:throw new Error("Unknown Geometry Type")}}}}}function Gl(t,e,r,i){var n=r;return Ft(t,function(s,o,l,a,h){o===0&&r===void 0?n=s:n=e(n,s,o,l,a,h)},i),n}function qs(t,e){var r;switch(t.type){case"FeatureCollection":for(r=0;r<t.features.length&&e(t.features[r].properties,r)!==!1;r++);break;case"Feature":e(t.properties,0);break}}function Ql(t,e,r){var i=r;return qs(t,function(n,s){s===0&&r===void 0?i=n:i=e(i,n,s)}),i}function Pr(t,e){if(t.type==="Feature")e(t,0);else if(t.type==="FeatureCollection")for(var r=0;r<t.features.length&&e(t.features[r],r)!==!1;r++);}function Zl(t,e,r){var i=r;return Pr(t,function(n,s){s===0&&r===void 0?i=n:i=e(i,n,s)}),i}function ec(t){var e=[];return Ft(t,function(r){e.push(r)}),e}function Ji(t,e){var r,i,n,s,o,l,a,h,p,f,b=0,y=t.type==="FeatureCollection",_=t.type==="Feature",A=y?t.features.length:1;for(r=0;r<A;r++){for(l=y?t.features[r].geometry:_?t.geometry:t,h=y?t.features[r].properties:_?t.properties:{},p=y?t.features[r].bbox:_?t.bbox:void 0,f=y?t.features[r].id:_?t.id:void 0,a=l?l.type==="GeometryCollection":!1,o=a?l.geometries.length:1,n=0;n<o;n++){if(s=a?l.geometries[n]:l,s===null){if(e(null,b,h,p,f)===!1)return!1;continue}switch(s.type){case"Point":case"LineString":case"MultiPoint":case"Polygon":case"MultiLineString":case"MultiPolygon":{if(e(s,b,h,p,f)===!1)return!1;break}case"GeometryCollection":{for(i=0;i<s.geometries.length;i++)if(e(s.geometries[i],b,h,p,f)===!1)return!1;break}default:throw new Error("Unknown Geometry Type")}}b++}}function tc(t,e,r){var i=r;return Ji(t,function(n,s,o,l,a){s===0&&r===void 0?i=n:i=e(i,n,s,o,l,a)}),i}function et(t,e){Ji(t,function(r,i,n,s,o){var l=r===null?null:r.type;switch(l){case null:case"Point":case"LineString":case"Polygon":return e(Te(r,n,{bbox:s,id:o}),i,0)===!1?!1:void 0}var a;switch(l){case"MultiPoint":a="Point";break;case"MultiLineString":a="LineString";break;case"MultiPolygon":a="Polygon";break}for(var h=0;h<r.coordinates.length;h++){var p=r.coordinates[h],f={type:a,coordinates:p};if(e(Te(f,n),i,h)===!1)return!1}})}function rc(t,e,r){var i=r;return et(t,function(n,s,o){s===0&&o===0&&r===void 0?i=n:i=e(i,n,s,o)}),i}function Ns(t,e){et(t,function(r,i,n){var s=0;if(r.geometry){var o=r.geometry.type;if(!(o==="Point"||o==="MultiPoint")){var l,a=0,h=0,p=0;if(Ft(r,function(f,b,y,_,A){if(l===void 0||i>a||_>h||A>p){l=f,a=i,h=_,p=A,s=0;return}var z=Ne([l,f],r.properties);if(e(z,i,n,A,s)===!1)return!1;s++,l=f})===!1)return!1}}})}function ic(t,e,r){var i=r,n=!1;return Ns(t,function(s,o,l,a,h){n===!1&&r===void 0?i=s:i=e(i,s,o,l,a,h),n=!0}),i}function Hs(t,e){if(!t)throw new Error("geojson is required");et(t,function(r,i,n){if(r.geometry!==null){var s=r.geometry.type,o=r.geometry.coordinates;switch(s){case"LineString":if(e(r,i,n,0,0)===!1)return!1;break;case"Polygon":for(var l=0;l<o.length;l++)if(e(Ne(o[l],r.properties),i,n,l)===!1)return!1;break}}})}function nc(t,e,r){var i=r;return Hs(t,function(n,s,o,l){s===0&&r===void 0?i=n:i=e(i,n,s,o,l)}),i}function sc(t,e){if(e=e||{},!Ki(e))throw new Error("options is invalid");var r=e.featureIndex||0,i=e.multiFeatureIndex||0,n=e.geometryIndex||0,s=e.segmentIndex||0,o=e.properties,l;switch(t.type){case"FeatureCollection":r<0&&(r=t.features.length+r),o=o||t.features[r].properties,l=t.features[r].geometry;break;case"Feature":o=o||t.properties,l=t.geometry;break;case"Point":case"MultiPoint":return null;case"LineString":case"Polygon":case"MultiLineString":case"MultiPolygon":l=t;break;default:throw new Error("geojson is invalid")}if(l===null)return null;var a=l.coordinates;switch(l.type){case"Point":case"MultiPoint":return null;case"LineString":return s<0&&(s=a.length+s-1),Ne([a[s],a[s+1]],o,e);case"Polygon":return n<0&&(n=a.length+n),s<0&&(s=a[n].length+s-1),Ne([a[n][s],a[n][s+1]],o,e);case"MultiLineString":return i<0&&(i=a.length+i),s<0&&(s=a[i].length+s-1),Ne([a[i][s],a[i][s+1]],o,e);case"MultiPolygon":return i<0&&(i=a.length+i),n<0&&(n=a[i].length+n),s<0&&(s=a[i][n].length-s-1),Ne([a[i][n][s],a[i][n][s+1]],o,e)}throw new Error("geojson is invalid")}function oc(t,e){if(e=e||{},!Ki(e))throw new Error("options is invalid");var r=e.featureIndex||0,i=e.multiFeatureIndex||0,n=e.geometryIndex||0,s=e.coordIndex||0,o=e.properties,l;switch(t.type){case"FeatureCollection":r<0&&(r=t.features.length+r),o=o||t.features[r].properties,l=t.features[r].geometry;break;case"Feature":o=o||t.properties,l=t.geometry;break;case"Point":case"MultiPoint":return null;case"LineString":case"Polygon":case"MultiLineString":case"MultiPolygon":l=t;break;default:throw new Error("geojson is invalid")}if(l===null)return null;var a=l.coordinates;switch(l.type){case"Point":return Ye(a,o,e);case"MultiPoint":return i<0&&(i=a.length+i),Ye(a[i],o,e);case"LineString":return s<0&&(s=a.length+s),Ye(a[s],o,e);case"Polygon":return n<0&&(n=a.length+n),s<0&&(s=a[n].length+s),Ye(a[n][s],o,e);case"MultiLineString":return i<0&&(i=a.length+i),s<0&&(s=a[i].length+s),Ye(a[i][s],o,e);case"MultiPolygon":return i<0&&(i=a.length+i),n<0&&(n=a[i].length+n),s<0&&(s=a[i][n].length-s),Ye(a[i][n][s],o,e)}throw new Error("geojson is invalid")}const ac=Object.freeze(Object.defineProperty({__proto__:null,coordAll:ec,coordEach:Ft,coordReduce:Gl,featureEach:Pr,featureReduce:Zl,findPoint:oc,findSegment:sc,flattenEach:et,flattenReduce:rc,geomEach:Ji,geomReduce:tc,lineEach:Hs,lineReduce:nc,propEach:qs,propReduce:Ql,segmentEach:Ns,segmentReduce:ic},Symbol.toStringTag,{value:"Module"}));function Wn(t){if(!t)throw new Error("geojson is required");var e=[];return et(t,function(r){lc(r,e)}),ct(e)}function lc(t,e){var r=[],i=t.geometry;if(i!==null){switch(i.type){case"Polygon":r=Tt(i);break;case"LineString":r=[Tt(i)]}r.forEach(function(n){var s=cc(n,t.properties);s.forEach(function(o){o.id=e.length,e.push(o)})})}}function cc(t,e){var r=[];return t.reduce(function(i,n){var s=Ne([i,n],e);return s.bbox=hc(i,n),r.push(s),n}),r}function hc(t,e){var r=t[0],i=t[1],n=e[0],s=e[1],o=r<n?r:n,l=i<s?i:s,a=r>n?r:n,h=i>s?i:s;return[o,l,a,h]}var Gi={exports:{}},Fs={exports:{}};(function(t,e){(function(r,i){t.exports=i()})(Ot,function(){function r(g,m,w,E,S){(function k(L,H,F,D,re){for(;D>F;){if(D-F>600){var G=D-F+1,C=H-F+1,P=Math.log(G),M=.5*Math.exp(2*P/3),I=.5*Math.sqrt(P*M*(G-M)/G)*(C-G/2<0?-1:1),O=Math.max(F,Math.floor(H-C*M/G+I)),K=Math.min(D,Math.floor(H+(G-C)*M/G+I));k(L,H,O,K,re)}var Y=L[H],oe=F,ie=D;for(i(L,F,H),re(L[D],Y)>0&&i(L,F,D);oe<ie;){for(i(L,oe,ie),oe++,ie--;re(L[oe],Y)<0;)oe++;for(;re(L[ie],Y)>0;)ie--}re(L[F],Y)===0?i(L,F,ie):i(L,++ie,D),ie<=H&&(F=ie+1),H<=ie&&(D=ie-1)}})(g,m,w||0,E||g.length-1,S||n)}function i(g,m,w){var E=g[m];g[m]=g[w],g[w]=E}function n(g,m){return g<m?-1:g>m?1:0}var s=function(g){g===void 0&&(g=9),this._maxEntries=Math.max(4,g),this._minEntries=Math.max(2,Math.ceil(.4*this._maxEntries)),this.clear()};function o(g,m,w){if(!w)return m.indexOf(g);for(var E=0;E<m.length;E++)if(w(g,m[E]))return E;return-1}function l(g,m){a(g,0,g.children.length,m,g)}function a(g,m,w,E,S){S||(S=z(null)),S.minX=1/0,S.minY=1/0,S.maxX=-1/0,S.maxY=-1/0;for(var k=m;k<w;k++){var L=g.children[k];h(S,g.leaf?E(L):L)}return S}function h(g,m){return g.minX=Math.min(g.minX,m.minX),g.minY=Math.min(g.minY,m.minY),g.maxX=Math.max(g.maxX,m.maxX),g.maxY=Math.max(g.maxY,m.maxY),g}function p(g,m){return g.minX-m.minX}function f(g,m){return g.minY-m.minY}function b(g){return(g.maxX-g.minX)*(g.maxY-g.minY)}function y(g){return g.maxX-g.minX+(g.maxY-g.minY)}function _(g,m){return g.minX<=m.minX&&g.minY<=m.minY&&m.maxX<=g.maxX&&m.maxY<=g.maxY}function A(g,m){return m.minX<=g.maxX&&m.minY<=g.maxY&&m.maxX>=g.minX&&m.maxY>=g.minY}function z(g){return{children:g,height:1,leaf:!0,minX:1/0,minY:1/0,maxX:-1/0,maxY:-1/0}}function q(g,m,w,E,S){for(var k=[m,w];k.length;)if(!((w=k.pop())-(m=k.pop())<=E)){var L=m+Math.ceil((w-m)/E/2)*E;r(g,L,m,w,S),k.push(m,L,L,w)}}return s.prototype.all=function(){return this._all(this.data,[])},s.prototype.search=function(g){var m=this.data,w=[];if(!A(g,m))return w;for(var E=this.toBBox,S=[];m;){for(var k=0;k<m.children.length;k++){var L=m.children[k],H=m.leaf?E(L):L;A(g,H)&&(m.leaf?w.push(L):_(g,H)?this._all(L,w):S.push(L))}m=S.pop()}return w},s.prototype.collides=function(g){var m=this.data;if(!A(g,m))return!1;for(var w=[];m;){for(var E=0;E<m.children.length;E++){var S=m.children[E],k=m.leaf?this.toBBox(S):S;if(A(g,k)){if(m.leaf||_(g,k))return!0;w.push(S)}}m=w.pop()}return!1},s.prototype.load=function(g){if(!g||!g.length)return this;if(g.length<this._minEntries){for(var m=0;m<g.length;m++)this.insert(g[m]);return this}var w=this._build(g.slice(),0,g.length-1,0);if(this.data.children.length)if(this.data.height===w.height)this._splitRoot(this.data,w);else{if(this.data.height<w.height){var E=this.data;this.data=w,w=E}this._insert(w,this.data.height-w.height-1,!0)}else this.data=w;return this},s.prototype.insert=function(g){return g&&this._insert(g,this.data.height-1),this},s.prototype.clear=function(){return this.data=z([]),this},s.prototype.remove=function(g,m){if(!g)return this;for(var w,E,S,k=this.data,L=this.toBBox(g),H=[],F=[];k||H.length;){if(k||(k=H.pop(),E=H[H.length-1],w=F.pop(),S=!0),k.leaf){var D=o(g,k.children,m);if(D!==-1)return k.children.splice(D,1),H.push(k),this._condense(H),this}S||k.leaf||!_(k,L)?E?(w++,k=E.children[w],S=!1):k=null:(H.push(k),F.push(w),w=0,E=k,k=k.children[0])}return this},s.prototype.toBBox=function(g){return g},s.prototype.compareMinX=function(g,m){return g.minX-m.minX},s.prototype.compareMinY=function(g,m){return g.minY-m.minY},s.prototype.toJSON=function(){return this.data},s.prototype.fromJSON=function(g){return this.data=g,this},s.prototype._all=function(g,m){for(var w=[];g;)g.leaf?m.push.apply(m,g.children):w.push.apply(w,g.children),g=w.pop();return m},s.prototype._build=function(g,m,w,E){var S,k=w-m+1,L=this._maxEntries;if(k<=L)return l(S=z(g.slice(m,w+1)),this.toBBox),S;E||(E=Math.ceil(Math.log(k)/Math.log(L)),L=Math.ceil(k/Math.pow(L,E-1))),(S=z([])).leaf=!1,S.height=E;var H=Math.ceil(k/L),F=H*Math.ceil(Math.sqrt(L));q(g,m,w,F,this.compareMinX);for(var D=m;D<=w;D+=F){var re=Math.min(D+F-1,w);q(g,D,re,H,this.compareMinY);for(var G=D;G<=re;G+=H){var C=Math.min(G+H-1,re);S.children.push(this._build(g,G,C,E-1))}}return l(S,this.toBBox),S},s.prototype._chooseSubtree=function(g,m,w,E){for(;E.push(m),!m.leaf&&E.length-1!==w;){for(var S=1/0,k=1/0,L=void 0,H=0;H<m.children.length;H++){var F=m.children[H],D=b(F),re=(G=g,C=F,(Math.max(C.maxX,G.maxX)-Math.min(C.minX,G.minX))*(Math.max(C.maxY,G.maxY)-Math.min(C.minY,G.minY))-D);re<k?(k=re,S=D<S?D:S,L=F):re===k&&D<S&&(S=D,L=F)}m=L||m.children[0]}var G,C;return m},s.prototype._insert=function(g,m,w){var E=w?g:this.toBBox(g),S=[],k=this._chooseSubtree(E,this.data,m,S);for(k.children.push(g),h(k,E);m>=0&&S[m].children.length>this._maxEntries;)this._split(S,m),m--;this._adjustParentBBoxes(E,S,m)},s.prototype._split=function(g,m){var w=g[m],E=w.children.length,S=this._minEntries;this._chooseSplitAxis(w,S,E);var k=this._chooseSplitIndex(w,S,E),L=z(w.children.splice(k,w.children.length-k));L.height=w.height,L.leaf=w.leaf,l(w,this.toBBox),l(L,this.toBBox),m?g[m-1].children.push(L):this._splitRoot(w,L)},s.prototype._splitRoot=function(g,m){this.data=z([g,m]),this.data.height=g.height+1,this.data.leaf=!1,l(this.data,this.toBBox)},s.prototype._chooseSplitIndex=function(g,m,w){for(var E,S,k,L,H,F,D,re=1/0,G=1/0,C=m;C<=w-m;C++){var P=a(g,0,C,this.toBBox),M=a(g,C,w,this.toBBox),I=(S=P,k=M,L=void 0,H=void 0,F=void 0,D=void 0,L=Math.max(S.minX,k.minX),H=Math.max(S.minY,k.minY),F=Math.min(S.maxX,k.maxX),D=Math.min(S.maxY,k.maxY),Math.max(0,F-L)*Math.max(0,D-H)),O=b(P)+b(M);I<re?(re=I,E=C,G=O<G?O:G):I===re&&O<G&&(G=O,E=C)}return E||w-m},s.prototype._chooseSplitAxis=function(g,m,w){var E=g.leaf?this.compareMinX:p,S=g.leaf?this.compareMinY:f;this._allDistMargin(g,m,w,E)<this._allDistMargin(g,m,w,S)&&g.children.sort(E)},s.prototype._allDistMargin=function(g,m,w,E){g.children.sort(E);for(var S=this.toBBox,k=a(g,0,m,S),L=a(g,w-m,w,S),H=y(k)+y(L),F=m;F<w-m;F++){var D=g.children[F];h(k,g.leaf?S(D):D),H+=y(k)}for(var re=w-m-1;re>=m;re--){var G=g.children[re];h(L,g.leaf?S(G):G),H+=y(L)}return H},s.prototype._adjustParentBBoxes=function(g,m,w){for(var E=w;E>=0;E--)h(m[E],g)},s.prototype._condense=function(g){for(var m=g.length-1,w=void 0;m>=0;m--)g[m].children.length===0?m>0?(w=g[m-1].children).splice(w.indexOf(g[m]),1):this.clear():l(g[m],this.toBBox)},s})})(Fs);var uc=Fs.exports;const dc=Ti(Kl),pc=Ti(ac);function $t(t){var e=[1/0,1/0,-1/0,-1/0];return Ft(t,function(r){e[0]>r[0]&&(e[0]=r[0]),e[1]>r[1]&&(e[1]=r[1]),e[2]<r[0]&&(e[2]=r[0]),e[3]<r[1]&&(e[3]=r[1])}),e}$t.default=$t;const fc=Object.freeze(Object.defineProperty({__proto__:null,default:$t},Symbol.toStringTag,{value:"Module"})),gc=Ti(fc);var ze=uc,Bs=dc,Us=pc,Mt=gc.default,mc=Us.featureEach;Us.coordEach;Bs.polygon;var Vn=Bs.featureCollection;function zs(t){var e=new ze(t);return e.insert=function(r){if(r.type!=="Feature")throw new Error("invalid feature");return r.bbox=r.bbox?r.bbox:Mt(r),ze.prototype.insert.call(this,r)},e.load=function(r){var i=[];return Array.isArray(r)?r.forEach(function(n){if(n.type!=="Feature")throw new Error("invalid features");n.bbox=n.bbox?n.bbox:Mt(n),i.push(n)}):mc(r,function(n){if(n.type!=="Feature")throw new Error("invalid features");n.bbox=n.bbox?n.bbox:Mt(n),i.push(n)}),ze.prototype.load.call(this,i)},e.remove=function(r,i){if(r.type!=="Feature")throw new Error("invalid feature");return r.bbox=r.bbox?r.bbox:Mt(r),ze.prototype.remove.call(this,r,i)},e.clear=function(){return ze.prototype.clear.call(this)},e.search=function(r){var i=ze.prototype.search.call(this,this.toBBox(r));return Vn(i)},e.collides=function(r){return ze.prototype.collides.call(this,this.toBBox(r))},e.all=function(){var r=ze.prototype.all.call(this);return Vn(r)},e.toJSON=function(){return ze.prototype.toJSON.call(this)},e.fromJSON=function(r){return ze.prototype.fromJSON.call(this,r)},e.toBBox=function(r){var i;if(r.bbox)i=r.bbox;else if(Array.isArray(r)&&r.length===4)i=r;else if(Array.isArray(r)&&r.length===6)i=[r[0],r[1],r[3],r[4]];else if(r.type==="Feature")i=Mt(r);else if(r.type==="FeatureCollection")i=Mt(r);else throw new Error("invalid geojson");return{minX:i[0],minY:i[1],maxX:i[2],maxY:i[3]}},e}Gi.exports=zs;Gi.exports.default=zs;var yc=Gi.exports;const vc=Di(yc);function Qi(t,e){var r={},i=[];if(t.type==="LineString"&&(t=Te(t)),e.type==="LineString"&&(e=Te(e)),t.type==="Feature"&&e.type==="Feature"&&t.geometry!==null&&e.geometry!==null&&t.geometry.type==="LineString"&&e.geometry.type==="LineString"&&t.geometry.coordinates.length===2&&e.geometry.coordinates.length===2){var n=Kn(t,e);return n&&i.push(n),ct(i)}var s=vc();return s.load(Wn(e)),Pr(Wn(t),function(o){Pr(s.search(o),function(l){var a=Kn(o,l);if(a){var h=Tt(a).join(",");r[h]||(r[h]=!0,i.push(a))}})}),ct(i)}function Kn(t,e){var r=Tt(t),i=Tt(e);if(r.length!==2)throw new Error("<intersects> line1 must only contain 2 coordinates");if(i.length!==2)throw new Error("<intersects> line2 must only contain 2 coordinates");var n=r[0][0],s=r[0][1],o=r[1][0],l=r[1][1],a=i[0][0],h=i[0][1],p=i[1][0],f=i[1][1],b=(f-h)*(o-n)-(p-a)*(l-s),y=(p-a)*(s-h)-(f-h)*(n-a),_=(o-n)*(s-h)-(l-s)*(n-a);if(b===0)return null;var A=y/b,z=_/b;if(A>=0&&A<=1&&z>=0&&z<=1){var q=n+A*(o-n),g=s+A*(l-s);return Ye([q,g])}return null}function $i(t,e){e===void 0&&(e={});var r=It(t);switch(!e.properties&&t.type==="Feature"&&(e.properties=t.properties),r.type){case"Polygon":return bc(r,e);case"MultiPolygon":return xc(r,e);default:throw new Error("invalid poly")}}function bc(t,e){e===void 0&&(e={});var r=It(t),i=r.coordinates,n=e.properties?e.properties:t.type==="Feature"?t.properties:{};return Ys(i,n)}function xc(t,e){e===void 0&&(e={});var r=It(t),i=r.coordinates,n=e.properties?e.properties:t.type==="Feature"?t.properties:{},s=[];return i.forEach(function(o){s.push(Ys(o,n))}),ct(s)}function Ys(t,e){return t.length>1?Wi(t,e):Ne(t[0],e)}function wc(t,e){var r=!0;return et(t,function(i){et(e,function(n){if(r===!1)return!1;r=$c(i.geometry,n.geometry)})}),r}function $c(t,e){switch(t.type){case"Point":switch(e.type){case"Point":return!kc(t.coordinates,e.coordinates);case"LineString":return!Jn(e,t);case"Polygon":return!De(t,e)}break;case"LineString":switch(e.type){case"Point":return!Jn(t,e);case"LineString":return!_c(t,e);case"Polygon":return!Gn(e,t)}break;case"Polygon":switch(e.type){case"Point":return!De(e,t);case"LineString":return!Gn(t,e);case"Polygon":return!Ec(e,t)}}return!1}function Jn(t,e){for(var r=0;r<t.coordinates.length-1;r++)if(Sc(t.coordinates[r],t.coordinates[r+1],e.coordinates))return!0;return!1}function _c(t,e){var r=Qi(t,e);return r.features.length>0}function Gn(t,e){for(var r=0,i=e.coordinates;r<i.length;r++){var n=i[r];if(De(n,t))return!0}var s=Qi(e,$i(t));return s.features.length>0}function Ec(t,e){for(var r=0,i=t.coordinates[0];r<i.length;r++){var n=i[r];if(De(n,e))return!0}for(var s=0,o=e.coordinates[0];s<o.length;s++){var l=o[s];if(De(l,t))return!0}var a=Qi($i(t),$i(e));return a.features.length>0}function Sc(t,e,r){var i=r[0]-t[0],n=r[1]-t[1],s=e[0]-t[0],o=e[1]-t[1],l=i*o-n*s;return l!==0?!1:Math.abs(s)>=Math.abs(o)?s>0?t[0]<=r[0]&&r[0]<=e[0]:e[0]<=r[0]&&r[0]<=t[0]:o>0?t[1]<=r[1]&&r[1]<=e[1]:e[1]<=r[1]&&r[1]<=t[1]}function kc(t,e){return t[0]===e[0]&&t[1]===e[1]}function Mc(t,e){var r=!1;return et(t,function(i){et(e,function(n){if(r===!0)return!0;r=!wc(i.geometry,n.geometry)})}),r}function Or(t,e,r){r===void 0&&(r={});for(var i=Is(t),n=Tt(e),s=0;s<n.length-1;s++){var o=!1;if(r.ignoreEndVertices&&(s===0&&(o="start"),s===n.length-2&&(o="end"),s===0&&s+1===n.length-1&&(o="both")),Ac(n[s],n[s+1],i,o,typeof r.epsilon>"u"?null:r.epsilon))return!0}return!1}function Ac(t,e,r,i,n){var s=r[0],o=r[1],l=t[0],a=t[1],h=e[0],p=e[1],f=r[0]-l,b=r[1]-a,y=h-l,_=p-a,A=f*_-b*y;if(n!==null){if(Math.abs(A)>n)return!1}else if(A!==0)return!1;if(i){if(i==="start")return Math.abs(y)>=Math.abs(_)?y>0?l<s&&s<=h:h<=s&&s<l:_>0?a<o&&o<=p:p<=o&&o<a;if(i==="end")return Math.abs(y)>=Math.abs(_)?y>0?l<=s&&s<h:h<s&&s<=l:_>0?a<=o&&o<p:p<o&&o<=a;if(i==="both")return Math.abs(y)>=Math.abs(_)?y>0?l<s&&s<h:h<s&&s<l:_>0?a<o&&o<p:p<o&&o<a}else return Math.abs(y)>=Math.abs(_)?y>0?l<=s&&s<=h:h<=s&&s<=l:_>0?a<=o&&o<=p:p<=o&&o<=a;return!1}function Pc(t,e){var r=It(t),i=It(e),n=r.type,s=i.type;switch(n){case"Point":switch(s){case"MultiPoint":return Oc(r,i);case"LineString":return Or(r,i,{ignoreEndVertices:!0});case"Polygon":case"MultiPolygon":return De(r,i,{ignoreBoundary:!0});default:throw new Error("feature2 "+s+" geometry not supported")}case"MultiPoint":switch(s){case"MultiPoint":return Lc(r,i);case"LineString":return Rc(r,i);case"Polygon":case"MultiPolygon":return Cc(r,i);default:throw new Error("feature2 "+s+" geometry not supported")}case"LineString":switch(s){case"LineString":return jc(r,i);case"Polygon":case"MultiPolygon":return Dc(r,i);default:throw new Error("feature2 "+s+" geometry not supported")}case"Polygon":switch(s){case"Polygon":case"MultiPolygon":return Tc(r,i);default:throw new Error("feature2 "+s+" geometry not supported")}default:throw new Error("feature1 "+n+" geometry not supported")}}function Oc(t,e){var r,i=!1;for(r=0;r<e.coordinates.length;r++)if(Ws(e.coordinates[r],t.coordinates)){i=!0;break}return i}function Lc(t,e){for(var r=0;r<t.coordinates.length;r++){for(var i=!1,n=0;n<e.coordinates.length;n++)Ws(t.coordinates[r],e.coordinates[n])&&(i=!0);if(!i)return!1}return!0}function Rc(t,e){for(var r=!1,i=0;i<t.coordinates.length;i++){if(!Or(t.coordinates[i],e))return!1;r||(r=Or(t.coordinates[i],e,{ignoreEndVertices:!0}))}return r}function Cc(t,e){for(var r=!0,i=!1,n=0;n<t.coordinates.length;n++){if(i=De(t.coordinates[1],e),!i){r=!1;break}i=De(t.coordinates[1],e,{ignoreBoundary:!0})}return r&&i}function jc(t,e){for(var r=0;r<t.coordinates.length;r++)if(!Or(t.coordinates[r],e))return!1;return!0}function Dc(t,e){var r=$t(e),i=$t(t);if(!Xs(r,i))return!1;for(var n=!1,s=0;s<t.coordinates.length-1;s++){if(!De(t.coordinates[s],e))return!1;if(n||(n=De(t.coordinates[s],e,{ignoreBoundary:!0})),!n){var o=Ic(t.coordinates[s],t.coordinates[s+1]);n=De(o,e,{ignoreBoundary:!0})}}return n}function Tc(t,e){var r=$t(t),i=$t(e);if(!Xs(i,r))return!1;for(var n=0;n<t.coordinates[0].length;n++)if(!De(t.coordinates[0][n],e))return!1;return!0}function Xs(t,e){return!(t[0]>e[0]||t[2]<e[2]||t[1]>e[1]||t[3]<e[3])}function Ws(t,e){return t[0]===e[0]&&t[1]===e[1]}function Ic(t,e){return[(t[0]+e[0])/2,(t[1]+e[1])/2]}var qc=Object.defineProperty,Nc=Object.getOwnPropertyDescriptor,or=(t,e,r,i)=>{for(var n=i>1?void 0:i?Nc(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&qc(e,r,n),n};const Hc=(t,e)=>e?Mc(t,e):!0,Fc=(t,e)=>e?Pc(t,e):!0;let _i=class extends _e{reset(){Nt(this.filterObject),this.renderRoot.querySelector("eox-itemfilter-spatial-filter").reset(),this.requestUpdate()}createRenderRoot(){return this}render(){return de(this.filterObject,()=>{var t;return U`
  ...
  `)}
      ...
      ${de(this.items.filter(t=>t.stringifiedState||t._inProgress).length>0,()=>U`
        ...
        `)}
    `}};_t([Q()],ht.prototype,"idProperty",2);_t([Q()],ht.prototype,"items",2);_t([Q()],ht.prototype,"titleProperty",2);_t([Q()],ht.prototype,"unstyled",2);_t([rt()],ht.prototype,"inputText",2);_t([rt()],ht.prototype,"replaceInput",2);ht=_t([Ce("eox-itemfilter-inline")],ht);function tt(t){return Array.isArray?Array.isArray(t):Gs(t)==="[object Array]"}const Xc=1/0;function Wc(t){if(typeof t=="string")return t;let e=t+"";return e=="0"&&1/t==-Xc?"-0":e}function Vc(t){return t==null?"":Wc(t)}function Xe(t){return typeof t=="string"}function Ks(t){return typeof t=="number"}function Kc(t){return t===!0||t===!1||Jc(t)&&Gs(t)=="[object Boolean]"}function Js(t){return typeof t=="object"}function Jc(t){return Js(t)&&t!==null}function Le(t){return t!=null}function mi(t){return!t.trim().length}function Gs(t){return t==null?t===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(t)}const Gc="Incorrect 'index' type",Qc=t=>`Invalid value for key ${t}`,Zc=t=>`Pattern length exceeds max of ${t}.`,eh=t=>`Missing ${t} property in key`,th=t=>`Property 'weight' in key '${t}' must be a positive integer`,Qn=Object.prototype.hasOwnProperty;class rh{constructor(e){this._keys=[],this._keyMap={};let r=0;e.forEach(i=>{let n=Qs(i);this._keys.push(n),this._keyMap[n.id]=n,r+=n.weight}),this._keys.forEach(i=>{i.weight/=r})}get(e){return this._keyMap[e]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function Qs(t){let e=null,r=null,i=null,n=1,s=null;if(Xe(t)||tt(t))i=t,e=Zn(t),r=Si(t);else{if(!Qn.call(t,"name"))throw new Error(eh("name"));const o=t.name;if(i=o,Qn.call(t,"weight")&&(n=t.weight,n<=0))throw new Error(th(o));e=Zn(o),r=Si(o),s=t.getFn}return{path:e,id:r,weight:n,src:i,getFn:s}}function Zn(t){return tt(t)?t:t.split(".")}function Si(t){return tt(t)?t.join("."):t}function ih(t,e){let r=[],i=!1;const n=(s,o,l)=>{if(Le(s))if(!o[l])r.push(s);else{let a=o[l];const h=s[a];if(!Le(h))return;if(l===o.length-1&&(Xe(h)||Ks(h)||Kc(h)))r.push(Vc(h));else if(tt(h)){i=!0;for(let p=0,f=h.length;p<f;p+=1)n(h[p],o,l+1)}else o.length&&n(h,o,l+1)}};return n(t,Xe(e)?e.split("."):e,0),i?r:r[0]}const nh={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},sh={isCaseSensitive:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(t,e)=>t.score===e.score?t.idx<e.idx?-1:1:t.score<e.score?-1:1},oh={location:0,threshold:.6,distance:100},ah={useExtendedSearch:!1,getFn:ih,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1};var J={...sh,...nh,...oh,...ah};const lh=/[^ ]+/g;function ch(t=1,e=3){const r=new Map,i=Math.pow(10,e);return{get(n){const s=n.match(lh).length;if(r.has(s))return r.get(s);const o=1/Math.pow(s,.5*t),l=parseFloat(Math.round(o*i)/i);return r.set(s,l),l},clear(){r.clear()}}}class Zi{constructor({getFn:e=J.getFn,fieldNormWeight:r=J.fieldNormWeight}={}){this.norm=ch(r,3),this.getFn=e,this.isCreated=!1,this.setIndexRecords()}setSources(e=[]){this.docs=e}setIndexRecords(e=[]){this.records=e}setKeys(e=[]){this.keys=e,this._keysMap={},e.forEach((r,i)=>{this._keysMap[r.id]=i})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,Xe(this.docs[0])?this.docs.forEach((e,r)=>{this._addString(e,r)}):this.docs.forEach((e,r)=>{this._addObject(e,r)}),this.norm.clear())}add(e){const r=this.size();Xe(e)?this._addString(e,r):this._addObject(e,r)}removeAt(e){this.records.splice(e,1);for(let r=e,i=this.size();r<i;r+=1)this.records[r].i-=1}getValueForItemAtKeyId(e,r){return e[this._keysMap[r]]}size(){return this.records.length}_addString(e,r){if(!Le(e)||mi(e))return;let i={v:e,i:r,n:this.norm.get(e)};this.records.push(i)}_addObject(e,r){let i={i:r,$:{}};this.keys.forEach((n,s)=>{let o=n.getFn?n.getFn(e):this.getFn(e,n.path);if(Le(o)){if(tt(o)){let l=[];const a=[{nestedArrIndex:-1,value:o}];for(;a.length;){const{nestedArrIndex:h,value:p}=a.pop();if(Le(p))if(Xe(p)&&!mi(p)){let f={v:p,i:h,n:this.norm.get(p)};l.push(f)}else tt(p)&&p.forEach((f,b)=>{a.push({nestedArrIndex:b,value:f})})}i.$[s]=l}else if(Xe(o)&&!mi(o)){let l={v:o,n:this.norm.get(o)};i.$[s]=l}}}),this.records.push(i)}toJSON(){return{keys:this.keys,records:this.records}}}function Zs(t,e,{getFn:r=J.getFn,fieldNormWeight:i=J.fieldNormWeight}={}){const n=new Zi({getFn:r,fieldNormWeight:i});return n.setKeys(t.map(Qs)),n.setSources(e),n.create(),n}function hh(t,{getFn:e=J.getFn,fieldNormWeight:r=J.fieldNormWeight}={}){const{keys:i,records:n}=t,s=new Zi({getFn:e,fieldNormWeight:r});return s.setKeys(i),s.setIndexRecords(n),s}function xr(t,{errors:e=0,currentLocation:r=0,expectedLocation:i=0,distance:n=J.distance,ignoreLocation:s=J.ignoreLocation}={}){const o=e/t.length;if(s)return o;const l=Math.abs(i-r);return n?o+l/n:l?1:o}function uh(t=[],e=J.minMatchCharLength){let r=[],i=-1,n=-1,s=0;for(let o=t.length;s<o;s+=1){let l=t[s];l&&i===-1?i=s:!l&&i!==-1&&(n=s-1,n-i+1>=e&&r.push([i,n]),i=-1)}return t[s-1]&&s-i>=e&&r.push([i,s-1]),r}const yt=32;function dh(t,e,r,{location:i=J.location,distance:n=J.distance,threshold:s=J.threshold,findAllMatches:o=J.findAllMatches,minMatchCharLength:l=J.minMatchCharLength,includeMatches:a=J.includeMatches,ignoreLocation:h=J.ignoreLocation}={}){if(e.length>yt)throw new Error(Zc(yt));const p=e.length,f=t.length,b=Math.max(0,Math.min(i,f));let y=s,_=b;const A=l>1||a,z=A?Array(f):[];let q;for(;(q=t.indexOf(e,_))>-1;){let k=xr(e,{currentLocation:q,expectedLocation:b,distance:n,ignoreLocation:h});if(y=Math.min(k,y),_=q+p,A){let L=0;for(;L<p;)z[q+L]=1,L+=1}}_=-1;let g=[],m=1,w=p+f;const E=1<<p-1;for(let k=0;k<p;k+=1){let L=0,H=w;for(;L<H;)xr(e,{errors:k,currentLocation:b+H,expectedLocation:b,distance:n,ignoreLocation:h})<=y?L=H:w=H,H=Math.floor((w-L)/2+L);w=H;let F=Math.max(1,b-H+1),D=o?f:Math.min(b+H,f)+p,re=Array(D+2);re[D+1]=(1<<k)-1;for(let G=D;G>=F;G-=1){let C=G-1,P=r[t.charAt(C)];if(A&&(z[C]=+!!P),re[G]=(re[G+1]<<1|1)&P,k&&(re[G]|=(g[G+1]|g[G])<<1|1|g[G+1]),re[G]&E&&(m=xr(e,{errors:k,currentLocation:C,expectedLocation:b,distance:n,ignoreLocation:h}),m<=y)){if(y=m,_=C,_<=b)break;F=Math.max(1,2*b-_)}}if(xr(e,{errors:k+1,currentLocation:b,expectedLocation:b,distance:n,ignoreLocation:h})>y)break;g=re}const S={isMatch:_>=0,score:Math.max(.001,m)};if(A){const k=uh(z,l);k.length?a&&(S.indices=k):S.isMatch=!1}return S}function ph(t){let e={};for(let r=0,i=t.length;r<i;r+=1){const n=t.charAt(r);e[n]=(e[n]||0)|1<<i-r-1}return e}class eo{constructor(e,{location:r=J.location,threshold:i=J.threshold,distance:n=J.distance,includeMatches:s=J.includeMatches,findAllMatches:o=J.findAllMatches,minMatchCharLength:l=J.minMatchCharLength,isCaseSensitive:a=J.isCaseSensitive,ignoreLocation:h=J.ignoreLocation}={}){if(this.options={location:r,threshold:i,distance:n,includeMatches:s,findAllMatches:o,minMatchCharLength:l,isCaseSensitive:a,ignoreLocation:h},this.pattern=a?e:e.toLowerCase(),this.chunks=[],!this.pattern.length)return;const p=(b,y)=>{this.chunks.push({pattern:b,alphabet:ph(b),startIndex:y})},f=this.pattern.length;if(f>yt){let b=0;const y=f%yt,_=f-y;for(;b<_;)p(this.pattern.substr(b,yt),b),b+=yt;if(y){const A=f-yt;p(this.pattern.substr(A),A)}}else p(this.pattern,0)}searchIn(e){const{isCaseSensitive:r,includeMatches:i}=this.options;if(r||(e=e.toLowerCase()),this.pattern===e){let _={isMatch:!0,score:0};return i&&(_.indices=[[0,e.length-1]]),_}const{location:n,distance:s,threshold:o,findAllMatches:l,minMatchCharLength:a,ignoreLocation:h}=this.options;let p=[],f=0,b=!1;this.chunks.forEach(({pattern:_,alphabet:A,startIndex:z})=>{const{isMatch:q,score:g,indices:m}=dh(e,_,A,{location:n+z,distance:s,threshold:o,findAllMatches:l,minMatchCharLength:a,includeMatches:i,ignoreLocation:h});q&&(b=!0),f+=g,q&&m&&(p=[...p,...m])});let y={isMatch:b,score:b?f/this.chunks.length:1};return b&&i&&(y.indices=p),y}}class ut{constructor(e){this.pattern=e}static isMultiMatch(e){return es(e,this.multiRegex)}static isSingleMatch(e){return es(e,this.singleRegex)}search(){}}function es(t,e){const r=t.match(e);return r?r[1]:null}class fh extends ut{constructor(e){super(e)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(e){const r=e===this.pattern;return{isMatch:r,score:r?0:1,indices:[0,this.pattern.length-1]}}}class gh extends ut{constructor(e){super(e)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(e){const r=e.indexOf(this.pattern)===-1;return{isMatch:r,score:r?0:1,indices:[0,e.length-1]}}}class mh extends ut{constructor(e){super(e)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(e){const r=e.startsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[0,this.pattern.length-1]}}}class yh extends ut{constructor(e){super(e)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(e){const r=!e.startsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[0,e.length-1]}}}class vh extends ut{constructor(e){super(e)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(e){const r=e.endsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[e.length-this.pattern.length,e.length-1]}}}class bh extends ut{constructor(e){super(e)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(e){const r=!e.endsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[0,e.length-1]}}}class to extends ut{constructor(e,{location:r=J.location,threshold:i=J.threshold,distance:n=J.distance,includeMatches:s=J.includeMatches,findAllMatches:o=J.findAllMatches,minMatchCharLength:l=J.minMatchCharLength,isCaseSensitive:a=J.isCaseSensitive,ignoreLocation:h=J.ignoreLocation}={}){super(e),this._bitapSearch=new eo(e,{location:r,threshold:i,distance:n,includeMatches:s,findAllMatches:o,minMatchCharLength:l,isCaseSensitive:a,ignoreLocation:h})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(e){return this._bitapSearch.searchIn(e)}}class ro extends ut{constructor(e){super(e)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(e){let r=0,i;const n=[],s=this.pattern.length;for(;(i=e.indexOf(this.pattern,r))>-1;)r=i+s,n.push([i,r-1]);const o=!!n.length;return{isMatch:o,score:o?0:1,indices:n}}}const ki=[fh,ro,mh,yh,bh,vh,gh,to],ts=ki.length,xh=/ +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,wh="|";function $h(t,e={}){return t.split(wh).map(r=>{let i=r.trim().split(xh).filter(s=>s&&!!s.trim()),n=[];for(let s=0,o=i.length;s<o;s+=1){const l=i[s];let a=!1,h=-1;for(;!a&&++h<ts;){const p=ki[h];let f=p.isMultiMatch(l);f&&(n.push(new p(f,e)),a=!0)}if(!a)for(h=-1;++h<ts;){const p=ki[h];let f=p.isSingleMatch(l);if(f){n.push(new p(f,e));break}}}return n})}const _h=new Set([to.type,ro.type]);class Eh{constructor(e,{isCaseSensitive:r=J.isCaseSensitive,includeMatches:i=J.includeMatches,minMatchCharLength:n=J.minMatchCharLength,ignoreLocation:s=J.ignoreLocation,findAllMatches:o=J.findAllMatches,location:l=J.location,threshold:a=J.threshold,distance:h=J.distance}={}){this.query=null,this.options={isCaseSensitive:r,includeMatches:i,minMatchCharLength:n,findAllMatches:o,ignoreLocation:s,location:l,threshold:a,distance:h},this.pattern=r?e:e.toLowerCase(),this.query=$h(this.pattern,this.options)}static condition(e,r){return r.useExtendedSearch}searchIn(e){const r=this.query;if(!r)return{isMatch:!1,score:1};const{includeMatches:i,isCaseSensitive:n}=this.options;e=n?e:e.toLowerCase();let s=0,o=[],l=0;for(let a=0,h=r.length;a<h;a+=1){const p=r[a];o.length=0,s=0;for(let f=0,b=p.length;f<b;f+=1){const y=p[f],{isMatch:_,indices:A,score:z}=y.search(e);if(_){if(s+=1,l+=z,i){const q=y.constructor.type;_h.has(q)?o=[...o,...A]:o.push(A)}}else{l=0,s=0,o.length=0;break}}if(s){let f={isMatch:!0,score:l/s};return i&&(f.indices=o),f}}return{isMatch:!1,score:1}}}const Mi=[];function Sh(...t){Mi.push(...t)}function Ai(t,e){for(let r=0,i=Mi.length;r<i;r+=1){let n=Mi[r];if(n.condition(t,e))return new n(t,e)}return new eo(t,e)}const Rr={AND:"$and",OR:"$or"},Pi={PATH:"$path",PATTERN:"$val"},Oi=t=>!!(t[Rr.AND]||t[Rr.OR]),kh=t=>!!t[Pi.PATH],Mh=t=>!tt(t)&&Js(t)&&!Oi(t),rs=t=>({[Rr.AND]:Object.keys(t).map(e=>({[e]:t[e]}))});function io(t,e,{auto:r=!0}={}){const i=n=>{let s=Object.keys(n);const o=kh(n);if(!o&&s.length>1&&!Oi(n))return i(rs(n));if(Mh(n)){const a=o?n[Pi.PATH]:s[0],h=o?n[Pi.PATTERN]:n[a];if(!Xe(h))throw new Error(Qc(a));const p={keyId:Si(a),pattern:h};return r&&(p.searcher=Ai(h,e)),p}let l={children:[],operator:s[0]};return s.forEach(a=>{const h=n[a];tt(h)&&h.forEach(p=>{l.children.push(i(p))})}),l};return Oi(t)||(t=rs(t)),i(t)}function Ah(t,{ignoreFieldNorm:e=J.ignoreFieldNorm}){t.forEach(r=>{let i=1;r.matches.forEach(({key:n,norm:s,score:o})=>{const l=n?n.weight:null;i*=Math.pow(o===0&&l?Number.EPSILON:o,(l||1)*(e?1:s))}),r.score=i})}function Ph(t,e){const r=t.matches;e.matches=[],Le(r)&&r.forEach(i=>{if(!Le(i.indices)||!i.indices.length)return;const{indices:n,value:s}=i;let o={indices:n,value:s};i.key&&(o.key=i.key.src),i.idx>-1&&(o.refIndex=i.idx),e.matches.push(o)})}function Oh(t,e){e.score=t.score}function Lh(t,e,{includeMatches:r=J.includeMatches,includeScore:i=J.includeScore}={}){const n=[];return r&&n.push(Ph),i&&n.push(Oh),t.map(s=>{const{idx:o}=s,l={item:e[o],refIndex:o};return n.length&&n.forEach(a=>{a(s,l)}),l})}class Bt{constructor(e,r={},i){this.options={...J,...r},this.options.useExtendedSearch,this._keyStore=new rh(this.options.keys),this.setCollection(e,i)}setCollection(e,r){if(this._docs=e,r&&!(r instanceof Zi))throw new Error(Gc);this._myIndex=r||Zs(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight})}add(e){Le(e)&&(this._docs.push(e),this._myIndex.add(e))}remove(e=()=>!1){const r=[];for(let i=0,n=this._docs.length;i<n;i+=1){const s=this._docs[i];e(s,i)&&(this.removeAt(i),i-=1,n-=1,r.push(s))}return r}removeAt(e){this._docs.splice(e,1),this._myIndex.removeAt(e)}getIndex(){return this._myIndex}search(e,{limit:r=-1}={}){const{includeMatches:i,includeScore:n,shouldSort:s,sortFn:o,ignoreFieldNorm:l}=this.options;let a=Xe(e)?Xe(this._docs[0])?this._searchStringList(e):this._searchObjectList(e):this._searchLogical(e);return Ah(a,{ignoreFieldNorm:l}),s&&a.sort(o),Ks(r)&&r>-1&&(a=a.slice(0,r)),Lh(a,this._docs,{includeMatches:i,includeScore:n})}_searchStringList(e){const r=Ai(e,this.options),{records:i}=this._myIndex,n=[];return i.forEach(({v:s,i:o,n:l})=>{if(!Le(s))return;const{isMatch:a,score:h,indices:p}=r.searchIn(s);a&&n.push({item:s,idx:o,matches:[{score:h,value:s,norm:l,indices:p}]})}),n}_searchLogical(e){const r=io(e,this.options),i=(l,a,h)=>{if(!l.children){const{keyId:f,searcher:b}=l,y=this._findMatches({key:this._keyStore.get(f),value:this._myIndex.getValueForItemAtKeyId(a,f),searcher:b});return y&&y.length?[{idx:h,item:a,matches:y}]:[]}const p=[];for(let f=0,b=l.children.length;f<b;f+=1){const y=l.children[f],_=i(y,a,h);if(_.length)p.push(..._);else if(l.operator===Rr.AND)return[]}return p},n=this._myIndex.records,s={},o=[];return n.forEach(({$:l,i:a})=>{if(Le(l)){let h=i(r,l,a);h.length&&(s[a]||(s[a]={idx:a,item:l,matches:[]},o.push(s[a])),h.forEach(({matches:p})=>{s[a].matches.push(...p)}))}}),o}_searchObjectList(e){const r=Ai(e,this.options),{keys:i,records:n}=this._myIndex,s=[];return n.forEach(({$:o,i:l})=>{if(!Le(o))return;let a=[];i.forEach((h,p)=>{a.push(...this._findMatches({key:h,value:o[p],searcher:r}))}),a.length&&s.push({idx:l,item:o,matches:a})}),s}_findMatches({key:e,value:r,searcher:i}){if(!Le(r))return[];let n=[];if(tt(r))r.forEach(({v:s,i:o,n:l})=>{if(!Le(s))return;const{isMatch:a,score:h,indices:p}=i.searchIn(s);a&&n.push({score:h,key:e,value:s,idx:o,norm:l,indices:p})});else{const{v:s,n:o}=r,{isMatch:l,score:a,indices:h}=i.searchIn(s);l&&n.push({score:a,key:e,value:s,norm:o,indices:h})}return n}}Bt.version="7.0.0";Bt.createIndex=Zs;Bt.parseIndex=hh;Bt.config=J;Bt.parseQuery=io;Sh(Eh);const Rh=(t,e="highlight",r="title")=>{const i=(s,o,l)=>{const a=o.split(".");let h;for(h=0;h<a.length-1;h++)s=s[a[h]];s[a[h]]=l},n=(s,o=[])=>{let l="",a=0;return o.forEach(h=>{const p=h[1]+1;l+=[s.substring(a,h[0]),`<mark class="${e}">`,s.substring(h[0],p),"</mark>"].join(""),a=p}),l+=s.substring(a),l};return t.filter(({matches:s})=>s&&s.length).map(({item:s,matches:o})=>{const l={};for(const[a,h]of Object.entries(s))l[a]=h;return o.forEach(a=>{a.key===r&&i(l,a.key,n(a.value,a.indices))}),l})};let no;const Ch=(t,e)=>{no=new Bt(t,{threshold:.4,distance:50,includeMatches:!0,useExtendedSearch:!0,...e})},jh=async(t,e,r)=>{const i=Object.entries(e).filter(([,l])=>l.type==="text"||l.type==="select"||l.type==="multiselect").reduce((l,[a,h])=>{const p="$or",f=[],b=(y,_)=>{const A={};h.type==="text"?A[y]=`${_}`:A[a]=`="${y}"`,f.push(A)};return Object.entries(h.state).filter(([,y])=>y).forEach(([y,_])=>b(y,_)),f.length>0&&l.push({[p]:f}),l},[]);let n;if(!(i.length>0)&&r.matchAllWhenEmpty!==!1)n=t;else{const l={$and:[...i]},a=no.search(l);n=r.enableHighlighting?Rh(a,"highlight",r.titleProperty):a.map(h=>h.item)}const s=Object.entries(e).filter(([,l])=>l.type==="range").reduce((l,[a,h])=>(l[a]={min:h.state.min,max:h.state.max,format:h.format},l),{});if(Object.keys(s).length>0){const l=[];for(let a=0;a<n.length;a++){const h={};for(const[p,f]of Object.entries(s)){const b=y=>f.format==="date"?Lt(y).unix():y;Object.prototype.hasOwnProperty.call(n[a],p)?Array.isArray(n[a][p])?h[p]=s[p].min<=b(n[a][p][1])&&b(n[a][p][0])<=s[p].max:b(n[a][p])>=s[p].min&&b(n[a][p])<=s[p].max?h[p]=!0:h[p]=!1:h[p]=!0}Object.values(h).every(p=>!!p)&&l.push(n[a])}n=[...l]}const o=Object.entries(e).filter(([,l])=>l.type==="spatial").reduce((l,[a,h])=>(l[a]={geometry:h.state.geometry,mode:h.state.mode},l),{});if(Object.values(o).map(l=>l.geometry).filter(l=>!!l).length>0){const l=[];for(let a=0;a<n.length;a++){const h={};for(const p of Object.keys(o)){const f=o[p].mode||"within";Object.prototype.hasOwnProperty.call(n[a],p)&&(f==="within"?Fc(n[a][p],o[p].geometry):Hc(n[a][p],o[p].geometry))?h[p]=!0:h[p]=!1}Object.values(h).every(p=>!!p)&&l.push(n[a])}n=[...l]}return n},Dh=async(t,e,r)=>(await(await fetch(`${r.externalFilter(t,e)}`)).json()).features;var Th=Object.defineProperty,Ih=Object.getOwnPropertyDescriptor,nt=(t,e,r,i)=>{for(var n=i>1?void 0:i?Ih(e,r):e,s=t.length-1,o;s>=0;s--)(o=t[s])&&(n=(i?o(e,r,n):o(n))||n);return i&&n&&Th(e,r,n),n};class is{constructor(){this.aggregateResults=void 0,this.autoSpreadSingle=!1,this.enableHighlighting=!1,this.filterProperties=[],this.inlineMode=!1,this.matchAllWhenEmpty=!0,this.onFilter=()=>{},this.onSelect=()=>{},this.showResults=!0,this.titleProperty="title",this.expandMultipleFilters=!0,this.expandResults=!0,this.expandMultipleResults=!0}}let Ke=class extends ka{constructor(){super(...arguments),this._resultAggregation=[],this._items=[],this.filters={},this._config=new is,this.apply=t=>{this._items=t.map((r,i)=>({id:`item-${i}`,...r})),this._config.filterProperties.length&&this._config.filterProperties.forEach(r=>{const i={},n=s=>r.format==="date"?Lt(s).unix():parseInt(s);this._items.forEach(s=>{if(r.type==="range"){if(Array.isArray(s[r.key])){const o=[n(s[r.key][0]),n(s[r.key][1])];i.min=i.min!==void 0?Math.min(i.min,o[0]):o[0],i.max=i.max!==void 0?Math.max(i.max,o[1]):o[1]}else{const o=n(s[r.key]);i.min=i.min!==void 0?Math.min(i.min,o):o,i.max=i.max!==void 0?Math.max(i.max,o):o}return}Array.isArray(s[r.key])?s[r.key].forEach(o=>{i[o]=void 0}):r.type==="spatial"?(i.geometry=void 0,i.mode=r.mode||"intersects"):i[s[r.key]]=void 0}),this.filters[r.key||r.keys.join("|")]={...r,type:r.type||"multiselect",state:{...i,...r.state},...r.state&&{dirty:!1},...r.type==="range"&&{min:i.min,max:i.max,format:r.format}}}),this._config.matchAllWhenEmpty!==!1&&(this.results=this.sortResults(this._items),this.requestUpdate()),this._config.aggregateResults&&(this._resultAggregation=[...new Set(this._items.reduce((r,i)=>r.concat(i[this._config.aggregateResults]),[]))].sort((r,i)=>r.localeCompare(i)));const e=[];Object.values(this.filters).forEach(r=>{r.type==="text"?r.keys.forEach(i=>{e.includes(i)||e.push(i)}):(r.type==="select"||r.type==="multiselect")&&(e.includes(r.key)||e.push(r.key))}),Ch(this._items,{keys:e,...this._config.fuseConfig}),this.search()}}set items(t){this.apply(t)}get items(){return this._items}set config(t){const e=this._config;this._config={...new is,...t},this.requestUpdate("config",e)}get config(){return this._config}async search(){let t;this.config.externalFilter?t=await Dh(this._items,this.filters,this._config):t=await jh(this._items,this.filters,this._config),this.results=this.sortResults(t),this._config.onFilter(this.results,this.filters)}aggregateResults(t,e){return t.filter(r=>{const i=r[this._config.aggregateResults];let n;return this.filters[this._config.aggregateResults]&&(n=Object.keys(this.filters[this._config.aggregateResults]).filter(s=>this.filters[this._config.aggregateResults].state[s])),(!(n!=null&&n.length)||n.includes(e))&&Array.isArray(i)?i.includes(e):i===e})}createItemList(t){return U`
      <ul>
        ${vs(this.aggregateResults(this.results,t),e=>e.id,e=>{var r,i;return U`
            <li
            ...
            >
              <label>
                ...
                ${de(this.hasTemplate("result"),()=>this.renderTemplate("result",e,`result-${e.id}`),()=>U`
                    <span class="title"
                      >${qn(e[this._config.titleProperty])}</span
                    >
                  `)}
              </label>
            </li>
                      ...
                      ${this._config.aggregateResults?Kt(this._resultAggregation.filter(t=>this.aggregateResults(this.results,t).length),t=>U` ${de(this.aggregateResults(this.results,t).length===1&&this.config.autoSpreadSingle,()=>U` <div style="margin-left: -8px">
                                ...
                                <label>
                                  ...
                                  ${de(this.hasTemplate("result"),()=>this.renderTemplate("result",t,`result-${t.id}`),()=>U`
                                      <span class="title"
                                        >${qn(t[this._config.titleProperty])}</span
                                      >
                                    `)}
                                </label>
                              </li>`)}

import{X as x,b6 as f,bE as v,aT as g,o as e,q as r,R as i,g as w,U as l,p as n,bF as h,aU as b,f as c,N as m,k,aK as A,aQ as _}from"./eo-dash.CJXKHI6H.js";import{p as $}from"./VMain-hQLCz9wl.C1QENfrg.js";import"./framework.DO4zGIRL.js";import"./ssrBoot-Cl_4lcfi.DMVeHaia.js";class C extends HTMLElement{static get observedAttributes(){return["gap"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
        display: grid;
